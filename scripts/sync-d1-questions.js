...
// `online_only` přibylo 2026-09-06 (migrace 2026-09-06-online-only.sql): otázka, která
// se nekopíruje na web, takže její správná odpověď není veřejně k dohledání. Musí se
// synchronizovat z dat — jinak by se serverový fond do běžící databáze nikdy nedostal.
const SLOUPCE = ["id", "cc", "country", "band", "section", "question", "answer", "distractors",
  "quip_correct", "quip_wrong", "explanation", "more_fact", "about", "difficulty", "online_only"];
