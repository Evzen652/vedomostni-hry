  ...
  function renderModePick(){
    ...
    body.innerHTML = `<div class="qz-screen qz-modepick">
      ...
      <div class="qz-modes">
        ...
        ${window.ZKOnline ? `<button class="qz-mode" id="qz-mode-online"><div class="ic"><img class="ic-img" src="assets/mode-online.jpg" alt="" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'"><span class="ic-fb" style="display:none">${ICO_SOLO}</span></div><div class="t">Světová liga</div><div class="d">Online souboje o rating. Zatím hlavně s Čechy.</div></button>` : ""}
